...
1.  **Cliquer sur le bouton d'ajout**
    ...
    ![Bouton ajouter une photo](images/add_service_picture.png)
...
2.  **Transférer ou glisser l'image**
    ...
    ![Zone de téléchargement](images/upload_or_drag_picture.png)
...
3.  **Sélectionner le fichier**
    ...
    ![Sélection du fichier](images/choose_picture.png)
...
4.  **Recadrer l'image**
    ...
    ![Écran de recadrage](images/crop_compress_picture.png)

5.  **Visualiser le résultat**
    Votre photo apparaît maintenant dans le formulaire de l'offre de service.

    ![Photo ajoutée](images/service_picture_added.png)
