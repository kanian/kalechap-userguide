...
![Bouton Mettre à niveau](images/mettre_a_niveau.png)
...
![Carte de service actif](images/active_service_offer_card.png)

Cliquez sur le bouton pour désactiver le service :

![Bouton désactiver](images/disable_service.png)
